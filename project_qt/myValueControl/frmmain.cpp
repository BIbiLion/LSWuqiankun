...
void frmMain::InitTab1()
{
    ...
    gauge1=new myGauge1(ui->fm1);//yuan gongxing yibiaopan
    gauge2=new myGauge2(ui->fm1);//zhizhen       yibiaopan
    gauge2->setAnimating(true);

    gauge31=new myGauge3(ui->fm1);//zuoyou huakuai
    gauge31->setRange(0,50);
    gauge31->SetmyTopColor(Qt::red);
    connect(gauge31,SIGNAL(valueChanged(qreal)),this,SLOT(UpdateData3(qreal)));

    gauge32=new myGauge3(ui->fm1);//xiancheng keduxian
    ...
    mybattery1=new myBattery(ui->fm1);//dianchi
...
void frmMain::InitTab2()
{
    ...
    mynewled=new myNewLed(ui->fm2);//LED
