#include "mystarryitem.h"

MyStarryItem::MyStarryItem(QGraphicsItem *parent)
...
MyStarryItem::MyStarryItem(qreal w,qreal h,qreal m,QGraphicsItem *parent)
...
QRectF MyStarryItem::boundingRect() const
{
	return QRectF(0, 0, width, height);
}

void MyStarryItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *option,QWidget *widget)
{
	Q_UNUSED(widget);
	...
	QPointF point1(margin,margin);
	QPointF point2(width-margin,margin);
	QPointF point3(width/2,height/2);
	QPointF point4(width/2, height);
 ...
 void MyStarryItem::createResizeFocus()
 {
...
void MyStarryItem::showResizeFocus(bool visible)
{
 ...
 void MyStarryItem::mousePressEvent(QGraphicsSceneMouseEvent *event)
 {
 ...
 void MyStarryItem::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
 {
	 if(myMode == RESIZE)
	 {
 ...
 void MyStarryItem::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
 {
	 if(myMode == RESIZE)
	 {
