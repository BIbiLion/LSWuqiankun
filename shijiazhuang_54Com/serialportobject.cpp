...
void SerialPortObject::writeDate(const char *data, qint64 len)
{
...
*/
 void SerialPortObject::write(const char *data, qint64 len)
 {
     m_serialPort->write(data,len);
 }
