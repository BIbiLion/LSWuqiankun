#include "testchardirect2.h"


#include "chartdir.h"
#include "qchartviewer.h"
#include <QDebug>
void testCharDirect2::draw(QWidget * w)
{
	if(c !=NULL)
	{
		delete c;
    ...
    c = new XYChart(w->width(), w->height());
    ...
    // (0xc0c0c0)
    c->setPlotArea(50, 50, w->width()-50, w->height()-100, 0xffffff, -1, 0xc0c0c0, 0xc0c0c0, -1);
...
testCharDirect2::testCharDirect2(QWidget *parent)
	: QWidget(parent) ,c(NULL),_vew(NULL)
{
	ui.setupUi(this);
...
testCharDirect2::~testCharDirect2()
{

}


   void	testCharDirect2::resizeEvent(QResizeEvent * event)
   {
	     qDebug()<<this->height()<<"..."<<this->width()<<"..............."<<this->rect().height()<<"..."<<this->rect().width();
	     draw(this);
