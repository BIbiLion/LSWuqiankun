...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SlaveThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 29, 7)
    ...
    "SlaveThread\0request\0\0s\0error\0timeout\0"
};
...
void SlaveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SlaveThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveThread::request)) {
                *result = 0;
            }
        }
        {
            typedef void (SlaveThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveThread::error)) {
                *result = 1;
            }
        }
        {
            typedef void (SlaveThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveThread::timeout)) {
                *result = 2;
            }
        }
    }
